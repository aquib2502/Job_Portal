...
export const registerUser = TryCatch(async (req, res, next) => {
  ...
  if (role === "recruiter") {
    try {
      ...
      console.error("DB Error while registering recruiter:", err);
      throw err;
    }
    ...
    if (!file) {
      console.error("Jobseeker Registration Error: Resume file missing");
    ...
    if (!fileBuffer || !fileBuffer.content) {
      console.error("Buffer Generation Error:", fileBuffer);
    ...
    try {
      ...
      console.error("DB Error while registering jobseeker:", err);
      throw err;
    }
  }
  ...
  try {
    ...
    console.error("JWT Generation / Response Error:", err);
    throw err;
  }
});
